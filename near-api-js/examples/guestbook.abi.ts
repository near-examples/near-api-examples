...
const abi = {
  ...
  "body": {
    "functions": [
      ...
      { "name": "contract_source_metadata", "kind": "view" },
      {
        "name": "get_messages",
        "kind": "view",
        "params": {
          "serialization_type": "json",
          "args": [
            { "name": "from_index", "type_schema": { "type": ["string", "null"] } },
            { "name": "limit", "type_schema": { "type": ["string", "null"] } }
          ]
        },
        "result": {
          "serialization_type": "json",
          "type_schema": {
            "type": "array",
            "items": { "$ref": "#/definitions/PostedMessage" }
          }
        }
      },
      {
      ...
      "definitions": {
        ...
        "PostedMessage": {
          ...
          "properties": {
            ...
            "sender": { "$ref": "#/definitions/AccountId" },
            "text": { "type": "string" }
          }
        }
      }
